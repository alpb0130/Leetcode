 ...
 * given the number of stones in the heap. For example, if there are 4 stones in the heap, then you
 * will never win the game: no matter 1, 2, or 3 stones you remove, the last stone will always be
